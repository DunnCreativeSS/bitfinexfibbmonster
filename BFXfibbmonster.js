...
+ '<script src="https://code.highcharts.com/stock/highstock.js"></script><script src="https://code.highcharts.com/stock/modules/exporting.js"></script><script src="https://code.highcharts.com/stock/modules/export-data.js"></script>'
		...
		+ '<div style="display:none;" id="prices">' + JSON.stringify(prices) + '</div>'
+ '<script>var prices=JSON.parse($("#prices").text()),btcusd=[],pl=[];for(var p in prices){var t=prices[p].t,btcusdt=prices[p].btcusd,plt=prices[p].pl;btcusd.push([t,btcusdt]),pl.push([t,plt])}var options={rangeSelector:{buttons:[{count:1,type:"minute",text:"1m"},{count:5,type:"minute",text:"5m"},{count:7,type:"minute",text:"7m"},{count:14,type:"minute",text:"14m"},{count:21,type:"minute",text:"21m"},{type:"all",text:"All"}]},yAxis:[{labels:{align:"right",x:-3},title:{text:"Price"},height:"60%",lineWidth:2,resize:{enabled:!0}}],title:{text:"Bitfinex Fibb Monster"},subtitle:{text:"By: Jarett Dunn jarettrsdunn@gmail.com"},yAxis:{title:{text:"%"}},legend:{layout:"vertical",align:"right",verticalAlign:"middle"},series:[{name:"BTCUSD",data:btcusd},{name:"P/L",data:pl}]};</script>'		+ '<script>Highcharts.stockChart("container", options);</script>');
})
			})
